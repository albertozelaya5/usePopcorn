...
export default function App() {
  ...
  /* Para el momento que se ejecute, watched ya estará con la version mas actualizada */
  useEffect(
    function () {
      //* Aquí se actualiza todo el array
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  function handleAdd() {
    ...
    // setavgImdbRating(Number(imdbRating));
    // setavgImdbRating((avgImdbRating) => (avgImdbRating + userRating) / 2);
    // alert(avgImdbRating);
  }
